  ...
  <div class="comm_warp">
    <div class="header">
      <headersList title="社区">
        <img
          @click="goMine"
          src="../../assets/community/icon_user_filled_focus.png"
          slot="rightImg"
          class="right"
        />
        ...
        <img
          @click="masg"
          src="../../assets/community/icon_entry_camera.png"
          slot="leftImg"
          class="left"
        />
      </headersList>
    ...
    <Tabbar class="uu">
      ...
      <div slot="list1">
        <yd-tab-panel label="话题" class="item_list">
          <img src="../../assets/community/d.jpeg" class="imgtt" />
        </yd-tab-panel>
      </div>
      <div slot="list1">
        <yd-tab-panel label="日记本">
          <img src="../../assets/community/b.jpg" class="imgtt" />
        </yd-tab-panel>
      </div>
      <div slot="list1">
        <yd-tab-panel label="同城" class="item_list">
          <img src="../../assets/community/e.jpeg" class="imgtt" />
        </yd-tab-panel>
      </div>
    </Tabbar>
    <!--回到顶部-->
